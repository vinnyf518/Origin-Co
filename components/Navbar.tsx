  ...
  const NavContent = (
    <div className="max-w-7xl mx-auto flex items-center justify-between glass rounded-full px-8 py-3">
      ...
      <button
        ...
        className="bg-white text-black px-5 py-2 rounded-full text-sm font-bold md:hover:bg-indigo-500 md:hover:text-white md:transition-all md:transform md:hover:scale-105 md:active:scale-95"
      >
        Get a Quote
      </button>
    </div>
